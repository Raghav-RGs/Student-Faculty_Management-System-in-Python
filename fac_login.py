...
def FCL_main():
    ...
    def fcl_login():
        ...
        if (con):
            ...
            cur = con.cursor()
            qry = "select ID,password from faculty"
            cur.execute(qry)
    ...
    heading = Label(sw,text=" Faculty Login ",font=('Calibri',36),border=1)
    ...
    btn = Button(sw, text="Log in", command=fcl_login,font=('arial',13,'bold'),borderwidth=5)
